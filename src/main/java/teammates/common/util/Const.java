...
public final class Const {
    ...
    public static class SystemParams {
        ...
        public static final List<String> PAGES_REQUIRING_ORIGIN_VALIDATION = Collections.unmodifiableList(
                Arrays.asList(
                        ...
                        ActionURIs.INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_ADD_LIKE,
                        ActionURIs.INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_CANCEL_LIKE,
    ...
    public static class Tooltips {
        ...
        public static final String COMMENT_ADD_LIKE = "Like this comment";
        public static final String COMMENT_CANCEL = "Cancel like this comment";
    ...
    public static class ActionURIs {
        ...
        public static final String INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_ADD_LIKE = "/page/instructorFeedbackResponseCommentAdd";
        public static final String INSTRUCTOR_FEEDBACK_RESPONSE_COMMENT_CANCEL_LIKE = "/page/instructorFeedbackResponseCommentDelete";
